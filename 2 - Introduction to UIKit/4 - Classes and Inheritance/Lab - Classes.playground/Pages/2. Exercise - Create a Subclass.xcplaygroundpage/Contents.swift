...
print("Because falcon is an instance of root class wheras weapon is a property of its subclass which is destroyer. so falcon can not access its properties. ")
